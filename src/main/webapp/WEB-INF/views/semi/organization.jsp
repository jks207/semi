        ...
        <div class="content_p">
          ...
          <table style="width: 100%">
            ...
            <tr>
              <td>&nbsp;</td>
              <td> </td>
              <td style="text-align: center;  padding: 10px;"><img width="30px;" src="https://journal-home.s3.ap-northeast-2.amazonaws.com/site/semi/downarrow_87468.png"/></td>
              <td> </td>
              <td> </td>
        ...
        <div class="content_p">
          ...
          <div class="row" style="width: 100%;">
            ...
            <div class="col-md-6">
              ...
              <a href="https://www.koreatech.ac.kr/mse/" target="_blank"><img style="margin:10px; width: 100%;" src="https://journal-home.s3.ap-northeast-2.amazonaws.com/site/semi/department/v1.png"/></a>
            </div>
            <div class="col-md-6">
              <h2 style="color:var(--main-color); font-size: 1.5em; margin: 10px;">에너지신소재화학공학부(화학생명공학전공)</h2>
              <a href="https://www.koreatech.ac.kr/ace/" target="_blank"><img style="margin:10px; width: 100%;" src="https://journal-home.s3.ap-northeast-2.amazonaws.com/site/semi/department/v2.png"/></a>
            </div>
            <div class="col-md-6">
              <h2 style="color:var(--main-color); font-size: 1.5em; margin: 10px;">기계공학부 </h2>
              <a href="https://www.koreatech.ac.kr/me/" target="_blank"><img style="margin:10px; width: 100%;" src="https://journal-home.s3.ap-northeast-2.amazonaws.com/site/semi/department/v3.png"/></a>
            </div>
            <div class="col-md-6">
              <h2 style="color:var(--main-color); font-size: 1.5em; margin: 10px;">메카트로닉스공학부 </h2>
              <a href="https://www.koreatech.ac.kr/mecha/" target="_blank"><img style="margin:10px; width: 100%;" src="https://journal-home.s3.ap-northeast-2.amazonaws.com/site/semi/department/v4.png"/></a>
            </div>
            <div class="col-md-6">
              <h2 style="color:var(--main-color); font-size: 1.5em; margin: 10px;">전기·전자·통신공학부 </h2>
              <a href="https://www.koreatech.ac.kr/ite/" target="_blank"><img style="margin:10px; width: 100%;" src="https://journal-home.s3.ap-northeast-2.amazonaws.com/site/semi/department/v5.png"/></a>
            </div>
